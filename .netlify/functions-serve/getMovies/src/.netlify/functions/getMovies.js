...
// .netlify/functions/getMovies.ts
axios_default.defaults.baseURL = process.env.VITE_BASE_API_URL;
axios_default.defaults.headers.common["Authorization"] = process.env.VITE_API_AUTH_TOKEN;
async function getMovies() {
  try {
    const resp = await axios_default.get(`movie/popular/?api_key=${process.env.VITE_API_KEY}`);
    return resp;
  } catch {
